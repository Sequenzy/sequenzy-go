...
package email_design_system_test
...
func TestEmailDesignSystemGetEmailDesignSystemWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.EmailDesignSystem.GetEmailDesignSystem(
		context.TODO(),
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestEmailDesignSystemGetEmailDesignSystemWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestEmailDesignSystemGetEmailDesignSystemWithWireMock", "GET", "/email-design-system", nil, 1)
}

func TestEmailDesignSystemUpdateEmailDesignSystemWithWireMock(
	t *testing.T,
) {
	WireMockBaseURL := os.Getenv("WIREMOCK_URL")
	if WireMockBaseURL == "" {
	...
	_, invocationErr := client.EmailDesignSystem.UpdateEmailDesignSystem(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestEmailDesignSystemUpdateEmailDesignSystemWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestEmailDesignSystemUpdateEmailDesignSystemWithWireMock", "PATCH", "/email-design-system", nil, 1)
}
