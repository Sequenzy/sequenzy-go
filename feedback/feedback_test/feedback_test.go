...
func TestFeedbackSubmitWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Feedback.Submit(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestFeedbackSubmitWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestFeedbackSubmitWithWireMock", "POST", "/feedback", nil, 1)
}
