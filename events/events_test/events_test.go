...
func TestEventsGetSchemasWithWireMock(
	...
	_, invocationErr := client.Events.GetSchemas(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestEventsGetSchemasWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestEventsGetSchemasWithWireMock", "GET", "/events/schemas", nil, 1)
}
