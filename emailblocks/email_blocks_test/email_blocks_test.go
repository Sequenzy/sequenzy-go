...
func TestEmailBlocksGetWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.EmailBlocks.Get(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestEmailBlocksGetWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestEmailBlocksGetWithWireMock", "GET", "/email-blocks/steps", nil, 1)
}

func TestEmailBlocksListWithWireMock(
	t *testing.T,
) {
	WireMockBaseURL := os.Getenv("WIREMOCK_URL")
	if WireMockBaseURL == "" {
	...
	_, invocationErr := client.EmailBlocks.List(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestEmailBlocksListWithWireMock"}},
		),
	)
